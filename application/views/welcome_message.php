...
<head>
    ...
    <!-- <script src="https://bootstrapcreative.com/wp-bc/wp-content/themes/wp-bootstrap/codepen/bootstrapcreative.js?v=7">
    </script> -->
    ...
    * {
    ...
    <!-- Google Fonts -->
    <link
        href="<?php echo base_url('https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Roboto:300,300i,400,400i,500,500i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i'); ?>"
        rel="stylesheet">
...
<header id="header">
    <div class="container d-flex">
        ...
        <div class="logo mr-auto">
            <h1 class="text-light"><a href="index.html"><img
                        src="<?php echo base_url('assets/img/team/logo.png'); ?>"></a></h1>
        ...
        <nav class="nav-menu d-none d-lg-block">
            ...
            ?>
                        <li><a
                                href="<?php echo site_url('Welcome/VProduct?kd_kategori=' . $ReadDS->kd_kategori); ?>"><?php echo $ReadDS->nama_kategori; ?></a>
                        </li>
                        <?php
              }
            }
                    ...
                    <div class="carousel-item <?php ($i == 0) ? print 'active' : print ''; ?>">
                        ...
                        <div class="carousel-container">
                            <div class="carousel-content">
                                ...
                                <a href="<?php echo site_url('Welcome/VAbout'); ?>"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-info">
                        <h3>WberPack</h3>
                        <p>
                            Jl. Raya Mayor Oking Jaya Atmaja No.158, Cirimekar, Cibinong, Bogor, Jawa Barat 16918
                            <br><br>
